...
* <details>
  ...
  <p align="center">
    <a href="https://youtu.be/YSQG_PBK8Nk?si=pA9HsE4aSMF1IbMO">
...
* <details>
  <summary><strong>👉 Ver Teste do EMAIL👈</strong></summary>
...
* **FTP:** No prompt de comando, utilize `ftp [192.168.30.10]` e realize o login para validar o acesso aos arquivos. (usuário = cisco, senha = cisco)
* <details>
